...
class LocalizationService {
  ...
  static Map<String, Map<String, String>> translations = {
    ...
    'ar': {
      "Reset & Login": "إعادة الضبط وتسجيل الدخول",
      "Confirm New Password": "تأكيد كلمة المرور الجديدة",
      "confirm password do not match": "تأكيد كلمة المرور غير متطابقة",
      ...
      "Verify": "يؤكد",
      "OTP Code": "رمز مكتب المدعي العام",
      "Please Check Your Mobile \nto See The Verification Code":
          "يرجى التحقق من هاتفك المحمول \nلرؤية رمز التحقق",
      "OTP Verification": "التحقق من OTP",
      "We have sent a password recovery code to your Mobile Number":
          "لقد أرسلنا رمز استعادة كلمة المرور إلى رقم هاتفك المحمول",
      "Check your Mobile": "تحقق من هاتفك المحمول",
      "Reset Password": "إعادة تعيين كلمة المرور",
      "Enter Your Mobile Number to reset\nYour Password":
          "أدخل رقم هاتفك المحمول لإعادة تعيين\nكلمة المرور الخاصة بك",
      ...
      "Fill Your Details or Continue with\n Social media":
          "املأ التفاصيل الخاصة بك أو تابع مع\n وسائل التواصل الاجتماعي",
      "SAR 74.67": "74.67 ريال سعودي",
      "Now you can send anything anywhere in a very low cost":
          "الآن يمكنك إرسال أي شيء إلى أي مكان بتكلفة منخفضة جدًا",
      "7 min ago": "منذ 7 دقائق",
      "Recent": "مؤخرًا",
      "Save Now": "احفظ الان",
      "enter details": "أدخل التفاصيل",
      "Pay by receiver method": "الدفع عن طريق طريقة المتلقي",
      ...
      "": "التسليم السريع في منزلك",
      "hello again!": "مرحبا مجددا!",
      "Quick Delivery at\nyour Home ": "التسليم السريع في\nمنزلك",
      "Book now": "احجز الآن",
      "No Ride In progress": "لا توجد رحلة قيد التقدم",
      "Quick another order": "سريع أمر آخر",
      "SAR 3.22/Km": "3.22 ريال سعودي/كم",
      "Truck": "شاحنة",
      "Car": "سيارة",
      "Profile": "حساب تعريفي",
      "Near by drivers": "بالقرب من السائقين",
      "Trips": "رحلات",
      ...
      "Are You Sure You Want To\nSign Out?":
          "هل أنت متأكد أنك تريد\nتسجيل الخروج؟",
      "Add Your Details for delivery": "أضف التفاصيل الخاصة بك للتسليم",
      "Add Picture *": "إضافة الصورة *",
      "Parcel Location": "موقع الطرود",
      "Receiver Location": "موقع جهاز الاستقبال",
      ...
      "We have sent your Delivery Request to your nearby diver":
          "لقد أرسلنا طلب التسليم الخاص بك إلى الغواص القريب منك",
      "OK": "نعم",
      "Proceed": "يتابع"
